...
public class SensorUmidadeController {
    ...
    @GetMapping("/")
    public ResponseEntity<List<SensorUmidade>> listarTodos() {
        List<SensorUmidade> sensores = sensorService.listarTodos();
        return ResponseEntity.ok(sensores);
    }

    @PostMapping("/")
    public ResponseEntity<SensorUmidade> criarSensor(@RequestBody @Valid SensorUmidade sensor) {
        SensorUmidade novoSensor = sensorService.salvar(sensor);
